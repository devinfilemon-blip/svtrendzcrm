...
$language['AddClient']="Add Client";
$language['ListClients']="List Clients";
$language['Support']="Support";
$language['Guards']="Guards";
$language['AddGuard']="Add Guard";
$language['ListGuards']="List Guards";
$language['Tracker']="Tracker";
$language['Scheduler']="Scheduler";
$language['Visitors']="Visitors";
$language['ListVisitors']="List Visitors";
$language['Subscription']="Subscription";
$language['AddSubscription']="Add Subscription";
$language['ListSubscription']="List Subscriptions";
