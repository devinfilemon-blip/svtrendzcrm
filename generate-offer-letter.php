...
?>
<head>
    <title><?php echo $isEdit ? 'Edit' : 'Add'; ?> Offer Letter</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18"><?php echo $isEdit ? 'Edit' : 'Add'; ?> Offer Letter</h4>
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="list-offer-letter.php">Offer Letters</a></li>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="offerForm" method="post" enctype="multipart/form-data" onsubmit="return false;">
                                    <input type="hidden" id="id" name="id" value="<?php echo $isEdit ? (int)$id : ''; ?>">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="ref_no">Ref No.</label>
                                                <input type="text" class="form-control" id="ref_no" name="ref_no" value="01" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="employee_name">Candidate Name</label>
                                                <input type="text" class="form-control" id="employee_name" name="employee_name" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="designation">Designation Offered</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label" for="employee_address">Candidate Address</label>
                                                <textarea class="form-control" id="employee_address" name="employee_address" rows="2"></textarea>
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="joining_date">Expected Joining Date</label>
                                                <input type="date" class="form-control" id="joining_date" name="joining_date" value="<?php echo date('Y-m-d'); ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="salary">CTC / Salary (₹)</label>
                                                <input type="text" class="form-control" id="salary" name="salary" placeholder="e.g. 3,60,000 per annum" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="probation">Probation Period</label>
                                                <input type="text" class="form-control" id="probation" name="probation" value="3 months" required>
                                            </div>
                                        </div>

                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="office_location">Work Location</label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label" for="validity_days">Offer Validity (days)</label>
                                                <input type="number" class="form-control" id="validity_days" name="validity_days" value="7" min="1" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                    ...
                                    <button type="button" class="btn btn-primary w-md" onclick="saveOfferLetter()"><?php echo $isEdit ? 'Update' : 'Save'; ?></button>
                                    <button type="button" class="btn btn-success w-md ms-2" onclick="previewOfferLetter()">Preview / Print</button>
                                    <a href="list-offer-letter.php" class="btn btn-secondary w-md ms-2">List</a>
                                </form>
                            </div>
                        </div>
                    </div>
...
function buildFormData(action) {
    var fd = new FormData(document.getElementById('offerForm'));
...
function saveOfferLetter() {
    ...
    var action = editId > 0 ? 'updateofferletter' : 'saveofferletter';
    fetch('hr-letter-api.php', { method: 'POST', body: buildFormData(action) })
        ...
        .then(function(res) {
            ...
            if (res.status === 'success') {
                ...
                setTimeout(function() { window.location.href = 'list-offer-letter.php'; }, 800);
            }
        })
...
function previewOfferLetter() {
    ...
    if (id > 0) {
        window.open('print-offer-letter.php?id=' + id, '_blank');
        return;
    }
    // Save first if not yet saved
    var action = 'saveofferletter';
    fetch('hr-letter-api.php', { method: 'POST', body: buildFormData(action) })
        .then(function(r) { return r.json(); })
        .then(function(res) {
            if (res.status === 'success' && res.data && res.data.id) {
                ...
                document.getElementById('id').value = editId;
                window.open('print-offer-letter.php?id=' + editId, '_blank');
            } else {
...
function fillOfferForm(d) {
    ...
    document.getElementById('probation').value = d.sProbation || '3 months';
    ...
    document.getElementById('validity_days').value = d.iValidityDays || 7;
