            ...
            <div class="container-fluid">
                ...
                <div class="crm-dash-hero mb-4">
                    <div class="crm-dash-hero-content">
                        ...
                        <p>Won projects for assigned users and lead owners. Open a project to add and track tasks.</p>
                    </div>
                ...
                <div class="crm-panel-card mb-0">
                    <div class="crm-panel-card-head">
                        <div>
                            <h6><i class="bx bx-briefcase me-1"></i> Won Projects</h6>
                            <p>Only leads with status <strong>Won</strong> appear here</p>
                        </div>
                    </div>
...
function loadProjects() {
    fetch('project-api.php', {
        ...
        body: JSON.stringify({ action: 'list_won_projects' })
    })
        .then(function (r) {
        ...
        .then(function (res) {
            ...
            if (!res || res.status !== 'success') {
                ...
                $tbody.html('<tr><td colspan="7" class="text-center text-muted">No Won projects found</td></tr>');
                return;
            }
            ...
            if (!rows.length) {
                $tbody.html('<tr><td colspan="7" class="text-center text-muted">No Won projects assigned to you yet</td></tr>');
                return;
            }
