                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="add-department.php" id="userForm" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div>
                                    <button type="button" class="btn btn-primary w-md" onclick="<?php if(isset($id)) echo "updatedepartment();" ;  else echo "adddepartment();" ?>">Save</button>
...
function adddepartment() {
    ...
    .then(responseData => {
        ...
        if (responseData.status === "success") {
           ...
           setTimeout(function() {
            window.location.href = 'list-department.php';  // Redirect to list of users
        }, 500);
        } else {
  ...
  var department = document.getElementById("department");
    ...
    .then(responseData => {
        ...
        if (responseData.data) {
           ...
           //redirect to list
           department.value=responseData.data.sDepartment;
