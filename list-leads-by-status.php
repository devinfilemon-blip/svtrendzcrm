        ...
        success: function(response) {
            if (response.status === 'success') {
                ...
                response.data.forEach((lead, index) => {
                    ...
                    rows += `<tr>
                        <td>${index + 1}</td>
                        <td onclick="triggerReplay(${lead.iLead_id})" style="cursor:pointer;color:blue;text-decoration:underline;">${lead.sCompany_name}</td>
                        <td onclick="triggerReplay(${lead.iLead_id})" style="cursor:pointer;color:blue;text-decoration:underline;">${lead.sLead_name}</td>
                        <td onclick="triggerReplay(${lead.iLead_id})" style="cursor:pointer;color:blue;text-decoration:underline;">${lead.sPrioritylevel || 'N/A'}</td>
                ...
                $('#datatable tbody').html('<tr><td colspan="7">No leads found for this status.</td></tr>');
            }
        },
        error: function(xhr, status, error) {
