                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">List product</h4>
            ...
            if (response.status === 'success') {
                ...
                products.forEach(function(product, index) {
                    productRows += `<tr>
                      ...
                      <td>${product.sCategoryname ?? '-'}</td>

                        <td>
                            <form action="add-product.php" method="post">
                                <input type="hidden" name="id" value="${product.iProductid}">
                                <button type="submit" name="btnedit" value="Edit" class="btn btn-success">Edit</button>
                            </form>
                        </td>
                        <td>
                            <button class="btn btn-danger delete-btn" onclick="deleteproduct(${product.iProductid})">Delete</button>
                        </td>
                    </tr>`;
                });
